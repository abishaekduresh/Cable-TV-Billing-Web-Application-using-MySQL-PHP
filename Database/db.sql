...
CREATE TABLE `bill` (
  ...
  `date` date NOT NULL,
  `time` time NOT NULL,
  `bill_by` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `mso` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `stbno` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `phone` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  `description` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `pMode` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `customer` (
  ...
  `date` date NOT NULL,
  `time` time NOT NULL,
  `cusGroup` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `mso` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `stbno` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `phone` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  `description` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `amount` int NOT NULL,
...
CREATE TABLE `groupinfo` (
  `group_id` int NOT NULL,
  `createdBy` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `date` date NOT NULL,
  `time` time NOT NULL,
  `groupName` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `in_ex_category` (
  ...
  `in_ex` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `loc_prop_login` (
  ...
  `created_at` datetime NOT NULL,
  `loc_gen_bill_id` int NOT NULL,
  `channel_uid` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `settings` (
  `id` int NOT NULL,
  `appName` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `appName2` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(35) COLLATE utf8mb4_general_ci NOT NULL,
  `addr1` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `addr2` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `phone` bigint NOT NULL,
  `prtFooter1` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `prtFooter2` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `lastUpdateBy` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
