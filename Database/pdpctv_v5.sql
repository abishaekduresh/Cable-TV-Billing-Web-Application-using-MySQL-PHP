...
DROP TABLE IF EXISTS `loc_bills`;
...
DROP TABLE IF EXISTS `loc_channels`;
...
DROP TABLE IF EXISTS `loc_gen_bills`;
...
DROP TABLE IF EXISTS `loc_gen_bills_log`;
...
DROP TABLE IF EXISTS `loc_prop_login`;
