    ...
    <table class="table table-hover" border="5">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                            ...
                                            // $query = "SELECT *
                                            // FROM billgroup AS bg 
                                            //     JOIN billgroupdetails AS bgd ON bg.groupID = bgd.groupID 
                                            //         WHERE bgd.groupID = '$groupID' AND bgd.date BETWEEN '$from_date' AND '$to_date'
                                            //             AND bgd.status = 'approve'
                                            // "; 


                                            // $query = "SELECT *
                                            // FROM billgroup 
                                            //     WHERE groupID = '$groupID' AND date BETWEEN '$from_date' AND '$to_date'
                                            //     AND status = 'approve'
                                            // "; 

                                            $query = "SELECT bg.*, bgd.pMode
                                                        FROM billgroup bg
                                                        LEFT JOIN billgroupdetails bgd ON bg.billNo = bgd.billGroupNo
                                                        WHERE bgd.groupID = '$groupID' AND bg.groupID = '$groupID' 
                                                            AND bgd.date BETWEEN '$from_date' AND '$to_date'
                                                            AND bgd.status = 'approve' AND bgd.pMode='credit'                                                                                     
                                            "; 
    ...
    <table class="table table-hover" border="5">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                            ...
                                            $query1 = "SELECT *
                                            FROM billgroupdetails WHERE groupID = '$groupID' AND date BETWEEN '$from_date' AND '$to_date'
