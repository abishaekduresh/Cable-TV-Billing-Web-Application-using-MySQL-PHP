            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="excelFile1" class="form-label">Upload First Excel File (.xls or .xlsx):</label>
                            <input type="file" name="excelFile1" id="excelFile1" class="form-control" accept=".xls, .xlsx" required>
                        </div>
                        <div class="mb-3">
                            <label for="excelFile2" class="form-label">Upload Second Excel File (.xls or .xlsx):</label>
                            <input type="file" name="excelFile2" id="excelFile2" class="form-control" accept=".xls, .xlsx" required>
                        </div>
